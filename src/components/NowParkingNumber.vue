<template>
  <div class="NowParkingNumber toolsView">
    <button @click="nowParkingNumber" class="css-button-arrow--red">
      获取现有车位
    </button>
    <p>{{ info }}</p>
  </div>
